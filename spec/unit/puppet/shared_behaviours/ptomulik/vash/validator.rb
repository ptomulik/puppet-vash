...
#############################################################################
# Stable "snapshot" of the Puppet::Util::PTomulik::Vash::Validator module.
#
# This is a copy of stable and tested version of Validator module. In specs we
# compare behaviour of Puppet::Util::PTomulik::Vash::Validator against this
# module. If the behaviour of Puppet::Util::PTomulik::Vash::Validator diverges
...
#
module Puppet::SharedBehaviours::PTomulik::Vash::ValidatorMod
  ...
  def vash_key_exception(key, *args)
    ...
    [Puppet::Util::PTomulik::Vash::InvalidKeyError, msg]
  end
...
#############################################################################
# @todo write docs for Puppet::SharedBehaviours::PTomulik::Vash::Validator
# TODO: write docs for Puppet::SharedBehaviours::PTomulik::Vash::Validator
#
class Puppet::SharedBehaviours::PTomulik::Vash::Validator
  include Puppet::SharedBehaviours::PTomulik::Vash::ValidatorMod
end
#############################################################################
...
#
# when testing Puppet::Util::PTomulik::Vash::Validator, or
#
#     require 'unit/puppet/shared_behaviours/ptomulik/vash/validator'
#     # ...
...
# `spec/unit/puppet/util/ptomulik/vash/validator_spec.rb`.
#
...
shared_examples 'Vash::Validator' do |_params|
  ...
  model_class     = (_params.delete(:model_class) ||
                     Puppet::SharedBehaviours::PTomulik::Vash::Validator).dup
